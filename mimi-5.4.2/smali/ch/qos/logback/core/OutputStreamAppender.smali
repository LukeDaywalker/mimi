...
.method protected closeOutputStream()V
    ...
    const-string/jumbo v2, "Could not close output stream for OutputStreamAppender."
...
.method encoderClose()V
    ...
    const-string/jumbo v3, "Failed to write footer for appender named ["
...
.method encoderInit()V
    ...
    const-string/jumbo v3, "Failed to initialize encoder for appender named ["
...
.method public setLayout(Lch/qos/logback/core/Layout;)V
    ...
    const-string/jumbo v0, "This appender no longer admits a layout as a sub-component, set an encoder instead."

    invoke-virtual {p0, v0}, Lch/qos/logback/core/OutputStreamAppender;->addWarn(Ljava/lang/String;)V

    const-string/jumbo v0, "To ensure compatibility, wrapping your layout in LayoutWrappingEncoder."

    invoke-virtual {p0, v0}, Lch/qos/logback/core/OutputStreamAppender;->addWarn(Ljava/lang/String;)V

    const-string/jumbo v0, "See also http://logback.qos.ch/codes.html#layoutInsteadOfEncoder for details"
...
.method public setOutputStream(Ljava/io/OutputStream;)V
    ...
    const-string/jumbo v0, "Encoder has not been set. Cannot invoke its init method."
...
.method public start()V
    ...
    const-string/jumbo v2, "No encoder set for the appender named \""
    ...
    const-string/jumbo v3, "No output stream set for the appender named \""
...
.method protected subAppend(Ljava/lang/Object;)V
    ...
    const-string/jumbo v3, "IO failure in appender"

...
.method compile()Lch/qos/logback/core/pattern/Converter;
    ...
    const-string/jumbo v3, "Failed to create converter for [%"
    ...
    const-string/jumbo v4, "%PARSER_ERROR["
    ...
    const-string/jumbo v4, "] is not a valid conversion word"
...
.method createCompositeConverter(Lch/qos/logback/core/pattern/parser/CompositeNode;)Lch/qos/logback/core/pattern/CompositeConverter;
    ...
    const-string/jumbo v6, "Failed to instantiate converter class ["
    ...
    const-string/jumbo v5, "] as a composite converter for keyword ["
    ...
    const-string/jumbo v3, "There is no conversion class registered for composite conversion word ["
...
.method createConverter(Lch/qos/logback/core/pattern/parser/SimpleKeywordNode;)Lch/qos/logback/core/pattern/DynamicConverter;
    ...
    const-string/jumbo v5, "] for keyword ["
    ...
    const-string/jumbo v3, "There is no conversion class registered for conversion word ["

...
.method public constructor <init>(Ljava/lang/String;Lch/qos/logback/core/pattern/util/IEscapeUtil;)V
    ...
    const-string/jumbo v2, "Failed to initialize Parser"
...
.method C()Lch/qos/logback/core/pattern/parser/FormattingNode;
    ...
    const-string/jumbo v1, "a LEFT_PARENTHESIS or KEYWORD"
...
.method COMPOSITE(Ljava/lang/String;)Lch/qos/logback/core/pattern/parser/FormattingNode;
    ...
    const-string/jumbo v2, "Expecting RIGHT_PARENTHESIS token but got "
    ...
    const-string/jumbo v1, "See also http://logback.qos.ch/codes.html#missingRightParenthesis"
...
.method T()Lch/qos/logback/core/pattern/parser/Node;
    ...
    const-string/jumbo v0, "a LITERAL or \'%\'"
    ...
    const-string/jumbo v1, "a FORMAT_MODIFIER, SIMPLE_KEYWORD or COMPOUND_KEYWORD"
...
.method expectNotNull(Lch/qos/logback/core/pattern/parser/Token;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "All tokens consumed but was expecting "

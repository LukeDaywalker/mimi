...
.method private postSuccessfulWrite()V
    ...
    const-string/jumbo v2, "Recovered from IO failure on "
...
.method public addStatus(Lch/qos/logback/core/status/Status;)V
    ...
    const-string/jumbo v2, "LOGBACK: No context given for "
...
.method addStatusIfCountNotOverLimit(Lch/qos/logback/core/status/Status;)V
    ...
    const-string/jumbo v2, "Will supress future messages regarding "
...
.method attemptRecovery()V
    ...
    const-string/jumbo v2, "Attempting to recover from IO failure on "
...
.method postIOFailure(Ljava/io/IOException;)V
    .locals 3
    ...
    const-string/jumbo v2, "IO failure while writing to "

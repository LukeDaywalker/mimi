...
.method private connect()Z
    ...
    const-string/jumbo v1, "Defaulting maxMessageSize to ["
    ...
    const-string/jumbo v2, "maxMessageSize of ["
    ...
    const-string/jumbo v2, "] is larger than the system defined datagram size of ["
    ...
    const-string/jumbo v0, "This may result in dropped logs."
    ...
    const-string/jumbo v1, "Could not create SyslogWriter"
    ...
    const-string/jumbo v1, "Failed to bind to a random datagram socket. Will try to reconnect later."
...
.method public static facilityStringToint(Ljava/lang/String;)I
    ...
    :cond_9
    const-string/jumbo v0, "AUTHPRIV"
    ...
    const-string/jumbo v2, " is not a valid syslog facility string"
...
.method protected append(Ljava/lang/Object;)V
    ...
    const-string/jumbo v2, "Failed to send diagram to "
...
.method public setLayout(Lch/qos/logback/core/Layout;)V
    ...
    const-string/jumbo v0, "The layout of a SyslogAppender cannot be set directly. See also http://logback.qos.ch/codes.html#syslog_layout"
...
.method public start()V
    ...
    const-string/jumbo v0, "The Facility option is mandatory"

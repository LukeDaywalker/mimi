...
.method private dispatchEvents()V
    ...
    const-string/jumbo v3, "connection established"
...
.method protected append(Ljava/lang/Object;)V
    ...
    const-string/jumbo v1, "Dropping event due to timeout limit of ["
    ...
    const-string/jumbo v1, "] milliseconds being exceeded"
    ...
    const-string/jumbo v1, "Interrupted while appending event to SocketAppender"
...
.method public connectionFailed(Lch/qos/logback/core/net/SocketConnector;Ljava/lang/Exception;)V
    ...
    const-string/jumbo v0, "connector interrupted"
...
.method public start()V
    ...
    const-string/jumbo v2, "No port was configured for appender"
    ...
    const-string/jumbo v2, " For more information, please visit http://logback.qos.ch/codes.html#socket_no_port"
    ...
    const-string/jumbo v2, "No remote host was configured for appender"
    ...
    const-string/jumbo v2, " For more information, please visit http://logback.qos.ch/codes.html#socket_no_host"
    ...
    const-string/jumbo v1, "Queue size must be non-negative"
    ...
    const-string/jumbo v1, "remote peer "

...
.method private buildSessionFromProperties()Ljavax/mail/Session;
    ...
    const-string/jumbo v0, "mail.smtp.host"
    ...
    :cond_0
    const-string/jumbo v0, "mail.smtp.port"
    ...
    const-string/jumbo v0, "mail.smtp.localhost"
    ...
    const-string/jumbo v2, "mail.smtp.auth"
    ...
    const-string/jumbo v2, "Both SSL and StartTLS cannot be enabled simultaneously"
    ...
    const-string/jumbo v2, "mail.smtp.starttls.enable"
    ...
    const-string/jumbo v2, "javax.net.ssl.SSLSocketFactory"

    const-string/jumbo v3, "mail.smtp.socketFactory.port"
    ...
    const-string/jumbo v3, "mail.smtp.socketFactory.class"

    invoke-virtual {v1, v3, v2}, Ljava/util/Properties;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v2, "mail.smtp.socketFactory.fallback"
...
.method private parseAddress(Ljava/lang/Object;)Ljava/util/List;
    ...
    const-string/jumbo v4, "Could not parse email address for ["
...
.method public addTo(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "Null or empty <to> property"
...
.method protected append(Ljava/lang/Object;)V
    ...
    const-string/jumbo v1, "SMTPAppender ["
    ...
    const-string/jumbo v1, "] is tracking ["
    ...
    const-string/jumbo v4, "SMTPAppender\'s EventEvaluator threw an Exception-"
...
.method public checkEntryConditions()Z
    ...
    const-string/jumbo v2, "Attempting to append to a non-started appender: "
    ...
    const-string/jumbo v1, "Message object not configured."
    ...
    const-string/jumbo v2, "No EventEvaluator is set for appender ["
    ...
    const-string/jumbo v2, "No layout set for appender named ["
    ...
    const-string/jumbo v2, "]. For more information, please visit http://logback.qos.ch/codes.html#smtp_no_layout"
...
.method getAddress(Ljava/lang/String;)Ljavax/mail/internet/InternetAddress;
    ...
    const-string/jumbo v2, "Could not parse address ["
...
.method protected sendBuffer(Lch/qos/logback/core/helpers/CyclicBuffer;Ljava/lang/Object;)V
    ...
    :cond_3
    const-string/jumbo v0, "Undefined subject"
    ...
    const-string/jumbo v0, "Empty destination address. Aborting email transmission"
    ...
    const-string/jumbo v3, "About to send out SMTP message \""
    ...
    const-string/jumbo v1, "Error occurred while sending e-mail notification."
...
.method public start()V
    ...
    const-string/jumbo v0, "Failed to obtain javax.mail.Session. Cannot start."
    ...
    const-string/jumbo v1, "Could not activate SMTPAppender options."

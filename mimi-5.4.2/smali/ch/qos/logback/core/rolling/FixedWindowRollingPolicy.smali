...
.method private transformFileNamePatternFromInt2Date(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "%d{yyyy-MM-dd_HHmm}"
...
.method public rollover()V
    ...
    const-string/jumbo v3, "Skipping roll-over for inexistent file "
...
.method public start()V
    ...
    const-string/jumbo v0, "Prudent mode is not supported with FixedWindowRollingPolicy."

    invoke-virtual {p0, v0}, Lch/qos/logback/core/rolling/FixedWindowRollingPolicy;->addError(Ljava/lang/String;)V

    const-string/jumbo v0, "See also http://logback.qos.ch/codes.html#tbr_fnp_prudent_unsupported"

    invoke-virtual {p0, v0}, Lch/qos/logback/core/rolling/FixedWindowRollingPolicy;->addError(Ljava/lang/String;)V

    new-instance v0, Ljava/lang/IllegalStateException;

    const-string/jumbo v1, "Prudent mode is not supported."
    ...
    :cond_0
    const-string/jumbo v0, "The \"FileNamePattern\" property must be set before using FixedWindowRollingPolicy. "

    invoke-virtual {p0, v0}, Lch/qos/logback/core/rolling/FixedWindowRollingPolicy;->addError(Ljava/lang/String;)V

    const-string/jumbo v0, "See also http://logback.qos.ch/codes.html#tbr_fnp_not_set"

    invoke-virtual {p0, v0}, Lch/qos/logback/core/rolling/FixedWindowRollingPolicy;->addError(Ljava/lang/String;)V

    new-instance v0, Ljava/lang/IllegalStateException;

    const-string/jumbo v1, "The \"FileNamePattern\" property must be set before using FixedWindowRollingPolicy. See also http://logback.qos.ch/codes.html#tbr_fnp_not_set"
    ...
    const-string/jumbo v0, "The File name property must be set before using this rolling policy."

    invoke-virtual {p0, v0}, Lch/qos/logback/core/rolling/FixedWindowRollingPolicy;->addError(Ljava/lang/String;)V

    const-string/jumbo v0, "Please refer to http://logback.qos.ch/codes.html#fwrp_parentFileName_not_set"

    invoke-virtual {p0, v0}, Lch/qos/logback/core/rolling/FixedWindowRollingPolicy;->addError(Ljava/lang/String;)V

    new-instance v0, Ljava/lang/IllegalStateException;

    const-string/jumbo v1, "The \"File\" option must be set."
    ...
    const-string/jumbo v1, ") cannot be smaller than MinIndex ("
    ...
    const-string/jumbo v0, "Setting maxIndex to equal minIndex."
    ...
    const-string/jumbo v1, "Large window sizes are not allowed."
    ...
    const-string/jumbo v1, "MaxIndex reduced to "
    ...
    const-string/jumbo v2, "FileNamePattern ["
    ...
    const-string/jumbo v2, "] does not contain a valid IntegerToken"

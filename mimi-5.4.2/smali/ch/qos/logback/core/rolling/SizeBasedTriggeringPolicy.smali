...
.method toFileSize(Ljava/lang/String;)J
    ...
    const-string/jumbo v4, "] is not in proper int format. Please refer to "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string/jumbo v4, "http://logback.qos.ch/codes.html#sbtp_size_format"
    ...
    const-string/jumbo v4, "] not in expected format."

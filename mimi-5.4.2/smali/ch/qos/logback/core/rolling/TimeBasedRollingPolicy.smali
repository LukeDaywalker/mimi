...
.method private waitForAsynchronousJobToStop()V
    ...
    const-string/jumbo v1, "Timeout while waiting for compression job to finish"
    ...
    const-string/jumbo v1, "Unexpected exception while waiting for compression job to finish"
...
.method public start()V
    ...
    const-string/jumbo v1, "Will use the pattern "
    ...
    const-string/jumbo v1, " for the active file"
    ...
    const-string/jumbo v0, "Cleaning on start up"
    ...
    :cond_3
    const-string/jumbo v0, "The FileNamePattern option must be set before using TimeBasedRollingPolicy. "
    ...
    const-string/jumbo v1, "The FileNamePattern option must be set before using TimeBasedRollingPolicy. See also http://logback.qos.ch/codes.html#tbr_fnp_not_set"
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v0, "c.q.l.core.rolling.TimeBasedRollingPolicy"

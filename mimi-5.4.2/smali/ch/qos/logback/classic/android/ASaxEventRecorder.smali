...
.method public recordEvents(Lorg/xml/sax/InputSource;)Ljava/util/List;
    ...
    const-string/jumbo v1, "Input source must specify an input stream"
    ...
    :cond_0
    :try_start_0
    new-instance v1, La/a/a/a/MCa;

    invoke-direct {v1, v0}, La/a/a/a/MCa;-><init>(Ljava/io/InputStream;)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {v1}, La/a/a/a/MCa;->next()I
    ...
    const-string/jumbo v2, "Can\'t parse Android XML resource"

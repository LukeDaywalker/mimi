...
.method private fallbackConfiguration(Lch/qos/logback/classic/LoggerContext;Ljava/util/List;Ljava/net/URL;)V
    ...
    # getter for: Lch/qos/logback/classic/turbo/ReconfigureOnChangeFilter;->context:Lch/qos/logback/core/Context;
    ...
    const-string/jumbo v2, "Falling back to previously registered safe configuration."
    ...
    const-string/jumbo v2, "Re-registering previous fallback configuration once more as a fallback configuration point"
    ...
    const-string/jumbo v2, "Unexpected exception thrown by a configuration considered safe."
    ...
    const-string/jumbo v1, "No previous configuration to fall back on."
...
.method public run()V
    ...
    const-string/jumbo v1, "Due to missing top level configuration file, skipping reconfiguration"
    ...
    const-string/jumbo v3, "Will reset and reconfigure context named ["

...
.method protected static doMain(Ljava/lang/Class;[Ljava/lang/String;)V
    ...
    :cond_0
    const-string/jumbo v1, "Wrong number of arguments."
...
.method static parsePortNumber(Ljava/lang/String;)I
    ...
    const-string/jumbo v1, "Could not interpret port number ["
...
.method static usage(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, " port configFile"
...
.method public close()V
    ...
    const-string/jumbo v1, "closing this server"
    ...
    const-string/jumbo v2, "Failed to close serverSocket"
    ...
    const-string/jumbo v1, "Was expecting a 0-sized socketNodeList after server shutdown"
...
.method protected getClientThreadName(Ljava/net/Socket;)Ljava/lang/String;
    ...
    const-string/jumbo v0, "Logback SocketNode (client: %s)"
...
.method protected getServerThreadName()Ljava/lang/String;
    ...
    const-string/jumbo v0, "Logback %s (port %d)"
...
.method public run()V
    ...
    const-string/jumbo v3, "Listening on port "
    ...
    const-string/jumbo v2, "Waiting to accept a new client."
    ...
    const-string/jumbo v4, "Connected to client at "
    ...
    const-string/jumbo v3, "Starting new socket node."
    ...
    const-string/jumbo v2, "Exception in run method for a closed server. This is normal."
    ...
    const-string/jumbo v3, "Unexpected failure in run method"

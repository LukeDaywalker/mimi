...
.method synthetic constructor <init>(Lu/aly/DeviceInfo$MCac;)V
    ...
    .prologue
    .line 1217
    invoke-direct {p0}, Lu/aly/DeviceInfo$MCaf;-><init>()V
...
.method public a(Lu/aly/TProtocol;Lu/aly/DeviceInfo;)V
    ...
    invoke-virtual {p1, v0}, Lu/aly/TTupleProtocol;->a(Z)V
...
.method public bridge synthetic a(Lu/aly/TProtocol;Lu/aly/TBase;)V
    ...
    invoke-virtual {p0, p1, p2}, Lu/aly/DeviceInfo$MCaf;->a(Lu/aly/TProtocol;Lu/aly/DeviceInfo;)V
...
.method public b(Lu/aly/TProtocol;Lu/aly/DeviceInfo;)V
    ...
    iput-object v1, p2, Lu/aly/DeviceInfo;->a:Ljava/lang/String;

    .line 1334
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->a(Z)V
    ...
    iput-object v1, p2, Lu/aly/DeviceInfo;->b:Ljava/lang/String;

    .line 1338
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->b(Z)V
    ...
    iput-object v1, p2, Lu/aly/DeviceInfo;->c:Ljava/lang/String;

    .line 1342
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->c(Z)V
    ...
    iput-object v1, p2, Lu/aly/DeviceInfo;->d:Ljava/lang/String;

    .line 1346
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->d(Z)V
    ...
    iput-object v1, p2, Lu/aly/DeviceInfo;->e:Ljava/lang/String;

    .line 1350
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->e(Z)V
    ...
    iput-object v1, p2, Lu/aly/DeviceInfo;->f:Ljava/lang/String;

    .line 1354
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->f(Z)V
    ...
    iput-object v1, p2, Lu/aly/DeviceInfo;->g:Ljava/lang/String;

    .line 1358
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->g(Z)V
    ...
    iput-object v1, p2, Lu/aly/DeviceInfo;->h:Ljava/lang/String;

    .line 1362
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->h(Z)V
    ...
    .line 1365
    new-instance v1, Lu/aly/Resolution;

    invoke-direct {v1}, Lu/aly/Resolution;-><init>()V

    iput-object v1, p2, Lu/aly/DeviceInfo;->i:Lu/aly/Resolution;

    .line 1366
    iget-object v1, p2, Lu/aly/DeviceInfo;->i:Lu/aly/Resolution;

    invoke-virtual {v1, p1}, Lu/aly/Resolution;->a(Lu/aly/TProtocol;)V

    .line 1367
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->i(Z)V
    ...
    .line 1370
    invoke-virtual {p1}, Lu/aly/TTupleProtocol;->p()Z

    move-result v1

    iput-boolean v1, p2, Lu/aly/DeviceInfo;->j:Z

    .line 1371
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->j(Z)V
    ...
    iput-boolean v1, p2, Lu/aly/DeviceInfo;->k:Z

    .line 1375
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->k(Z)V
    ...
    iput-object v1, p2, Lu/aly/DeviceInfo;->l:Ljava/lang/String;

    .line 1379
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->l(Z)V
    ...
    iput-object v1, p2, Lu/aly/DeviceInfo;->m:Ljava/lang/String;

    .line 1383
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->m(Z)V
    ...
    iput-wide v2, p2, Lu/aly/DeviceInfo;->n:J

    .line 1387
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->n(Z)V
    ...
    iput-object v1, p2, Lu/aly/DeviceInfo;->o:Ljava/lang/String;

    .line 1391
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->o(Z)V
    ...
    iput-object v1, p2, Lu/aly/DeviceInfo;->p:Ljava/lang/String;

    .line 1395
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->p(Z)V
    ...
    .line 1399
    invoke-virtual {p2, v4}, Lu/aly/DeviceInfo;->q(Z)V
...
.method public bridge synthetic b(Lu/aly/TProtocol;Lu/aly/TBase;)V
    ...
    invoke-virtual {p0, p1, p2}, Lu/aly/DeviceInfo$MCaf;->b(Lu/aly/TProtocol;Lu/aly/DeviceInfo;)V

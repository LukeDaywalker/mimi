...
# instance fields
.field final a:Landroid/support/v7/widget/y;
...
.method private a(Ljava/util/List;II)V
    ...
    .line 49
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/x;->a(Ljava/util/List;ILandroid/support/v7/widget/c;ILandroid/support/v7/widget/c;)V
    ...
    .line 52
    invoke-direct/range {v0 .. v5}, Landroid/support/v7/widget/x;->c(Ljava/util/List;ILandroid/support/v7/widget/c;ILandroid/support/v7/widget/c;)V
    ...
    .line 55
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/x;->b(Ljava/util/List;ILandroid/support/v7/widget/c;ILandroid/support/v7/widget/c;)V
...
.method a(Ljava/util/List;)V
    ...
    .line 39
    :goto_0
    invoke-direct {p0, p1}, Landroid/support/v7/widget/x;->b(Ljava/util/List;)I
    ...
    invoke-direct {p0, p1, v0, v1}, Landroid/support/v7/widget/x;->a(Ljava/util/List;II)V
...
.method a(Ljava/util/List;ILandroid/support/v7/widget/c;ILandroid/support/v7/widget/c;)V
    ...
    invoke-interface {v0, p3}, Landroid/support/v7/widget/y;->a(Landroid/support/v7/widget/c;)V
    ...
    invoke-interface {v0, p5}, Landroid/support/v7/widget/y;->a(Landroid/support/v7/widget/c;)V
    ...
    .line 103
    iget-object v4, p0, Landroid/support/v7/widget/x;->a:Landroid/support/v7/widget/y;

    iget v5, p3, Landroid/support/v7/widget/c;->b:I

    add-int/lit8 v5, v5, 0x1

    invoke-interface {v4, v1, v5, v3}, Landroid/support/v7/widget/y;->a(III)Landroid/support/v7/widget/c;
...
.method b(Ljava/util/List;ILandroid/support/v7/widget/c;ILandroid/support/v7/widget/c;)V
    ...
    invoke-interface {v0, v5, v2, v3}, Landroid/support/v7/widget/y;->a(III)Landroid/support/v7/widget/c;
    ...
    invoke-interface {v1, v5, v3, v2}, Landroid/support/v7/widget/y;->a(III)Landroid/support/v7/widget/c;
    ...
    .line 206
    iget-object v2, p0, Landroid/support/v7/widget/x;->a:Landroid/support/v7/widget/y;

    invoke-interface {v2, p5}, Landroid/support/v7/widget/y;->a(Landroid/support/v7/widget/c;)V

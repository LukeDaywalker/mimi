.class Landroid/support/v7/widget/LinearLayoutManager$t;
...
# direct methods
.method static synthetic a(Landroid/support/v7/widget/LinearLayoutManager$t;Landroid/view/View;Landroid/support/v7/widget/RecyclerView$bd;)Z
    .locals 1

    .prologue
    .line 2079
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/LinearLayoutManager$t;->a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$bd;)Z
...
.method private a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$bd;)Z
    .locals 2
    ...
    invoke-virtual {p2}, Landroid/support/v7/widget/RecyclerView$bd;->e()I
...
.method a()V
    ...
    iput v0, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->a:I

    .line 2085
    const/high16 v0, -0x80000000

    iput v0, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->b:I

    .line 2086
    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->c:Z
...
.method public a(Landroid/view/View;)V
    ...
    .line 2115
    iget-object v0, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->d:Landroid/support/v7/widget/LinearLayoutManager;
    ...
    .line 2117
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/LinearLayoutManager$t;->b(Landroid/view/View;)V
    ...
    .line 2120
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->d:Landroid/support/v7/widget/LinearLayoutManager;

    invoke-virtual {v1, p1}, Landroid/support/v7/widget/LinearLayoutManager;->d(Landroid/view/View;)I

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->a:I

    .line 2121
    iget-boolean v1, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->c:Z
    ...
    iput v1, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->b:I
    ...
    .line 2129
    iget v2, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->b:I

    sub-int v1, v2, v1

    .line 2130
    iget-object v2, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->d:Landroid/support/v7/widget/LinearLayoutManager;
    ...
    .line 2131
    iget-object v3, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->d:Landroid/support/v7/widget/LinearLayoutManager;
    ...
    .line 2155
    iget v1, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->b:I
...
.method b()V
    ...
    .prologue
    .line 2094
    iget-boolean v0, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->c:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget v1, p0, Landroid/support/v7/widget/LinearLayoutManager$t;->a:I

...
.field private d:Lcom/google/analytics/tracking/android/ao;
...
.method constructor <init>(Lorg/apache/http/client/HttpClient;Landroid/content/Context;)V
    ...
    .prologue
    .line 78
    invoke-static {p2}, Lcom/google/analytics/tracking/android/ao;->a(Landroid/content/Context;)Lcom/google/analytics/tracking/android/ao;

    move-result-object v0

    invoke-direct {p0, p1, v0, p2}, Lcom/google/analytics/tracking/android/bf;-><init>(Lorg/apache/http/client/HttpClient;Lcom/google/analytics/tracking/android/ao;Landroid/content/Context;)V

    .line 79
    return-void
.end method

.method constructor <init>(Lorg/apache/http/client/HttpClient;Lcom/google/analytics/tracking/android/ao;Landroid/content/Context;)V
    .locals 7
    ...
    iput-object v0, p0, Lcom/google/analytics/tracking/android/bf;->c:Landroid/content/Context;
    ...
    invoke-static {v0}, Lcom/google/analytics/tracking/android/bj;->a(Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/google/analytics/tracking/android/bf;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/google/analytics/tracking/android/bf;->a:Ljava/lang/String;

    .line 72
    iput-object p1, p0, Lcom/google/analytics/tracking/android/bf;->b:Lorg/apache/http/client/HttpClient;

    .line 74
    iput-object p2, p0, Lcom/google/analytics/tracking/android/bf;->d:Lcom/google/analytics/tracking/android/ao;
...
.method private a(Ljava/lang/String;Ljava/lang/String;)Lorg/apache/http/HttpEntityEnclosingRequest;
    ...
    iget-object v2, p0, Lcom/google/analytics/tracking/android/bf;->a:Ljava/lang/String;
...
.method public a(Ljava/util/List;)I
    ...
    .line 104
    invoke-virtual {p0, v0}, Lcom/google/analytics/tracking/android/bf;->a(Lcom/google/analytics/tracking/android/ap;)Ljava/net/URL;
    ...
    .line 107
    invoke-static {}, Lcom/google/analytics/tracking/android/ar;->a()Z
    ...
    invoke-virtual {v0}, Lcom/google/analytics/tracking/android/ap;->a()Ljava/lang/String;
    ...
    .line 129
    :goto_3
    invoke-direct {p0, v0, v6}, Lcom/google/analytics/tracking/android/bf;->a(Ljava/lang/String;Ljava/lang/String;)Lorg/apache/http/HttpEntityEnclosingRequest;
    ...
    invoke-static {v0, v8, v9}, Lcom/google/analytics/tracking/android/aq;->a(Lcom/google/analytics/tracking/android/ap;J)Ljava/lang/String;
    ...
    .line 136
    invoke-direct {p0, v6}, Lcom/google/analytics/tracking/android/bf;->a(Lorg/apache/http/HttpEntityEnclosingRequest;)V
    ...
    .line 141
    :cond_6
    iget-object v0, p0, Lcom/google/analytics/tracking/android/bf;->d:Lcom/google/analytics/tracking/android/ao;

    invoke-virtual {v0}, Lcom/google/analytics/tracking/android/ao;->b()Z
    ...
    .line 146
    :try_start_0
    iget-object v0, p0, Lcom/google/analytics/tracking/android/bf;->c:Landroid/content/Context;

    invoke-static {v0}, Lcom/google/analytics/tracking/android/v;->b(Landroid/content/Context;)V
    :try_end_0
    ...
    :goto_5
    :try_start_1
    iget-object v1, p0, Lcom/google/analytics/tracking/android/bf;->b:Lorg/apache/http/client/HttpClient;
...
.method a(Lcom/google/analytics/tracking/android/ap;)Ljava/net/URL;
    .locals 3

    .prologue
    .line 256
    iget-object v0, p0, Lcom/google/analytics/tracking/android/bf;->e:Ljava/net/URL;
    ...
    .line 260
    :cond_0
    invoke-virtual {p1}, Lcom/google/analytics/tracking/android/ap;->d()Ljava/lang/String;
...
.method public a(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/google/analytics/tracking/android/bf;->e:Ljava/net/URL;
    :try_end_0
    .catch Ljava/net/MalformedURLException; {:try_start_0 .. :try_end_0} :catch_0

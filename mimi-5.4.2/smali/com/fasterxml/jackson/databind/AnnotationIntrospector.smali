...
.method public refineDeserializationType(Lcom/fasterxml/jackson/databind/cfg/MapperConfig;Lcom/fasterxml/jackson/databind/introspect/Annotated;Lcom/fasterxml/jackson/databind/JavaType;)Lcom/fasterxml/jackson/databind/JavaType;
    ...
    const-string/jumbo v5, "Failed to narrow type %s with annotation (value %s), from \'%s\': %s"
    ...
    const-string/jumbo v6, "Failed to narrow key type of %s with concrete-type annotation (value %s), from \'%s\': %s"
    ...
    const-string/jumbo v6, "Failed to narrow value type of %s with concrete-type annotation (value %s), from \'%s\': %s"
...
.method public refineSerializationType(Lcom/fasterxml/jackson/databind/cfg/MapperConfig;Lcom/fasterxml/jackson/databind/introspect/Annotated;Lcom/fasterxml/jackson/databind/JavaType;)Lcom/fasterxml/jackson/databind/JavaType;
    ...
    const-string/jumbo v4, "Failed to widen type %s with annotation (value %s), from \'%s\': %s"
    ...
    const-string/jumbo v5, "Failed to widen key type of %s with concrete-type annotation (value %s), from \'%s\': %s"
    ...
    const-string/jumbo v5, "Failed to widen value type of %s with concrete-type annotation (value %s), from \'%s\': %s"

.class public Lcom/b/a/f/LocalSocketHttpServer;
...
# instance fields
.field private final b:Lcom/b/a/f/RegistryInitializer;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/b/a/f/LocalSocketHttpServer;->a:Ljava/util/concurrent/atomic/AtomicInteger;

    return-void
.end method

.method public constructor <init>(Lcom/b/a/f/RegistryInitializer;)V
    .locals 1
    ...
    invoke-direct {p0, p1, v0}, Lcom/b/a/f/LocalSocketHttpServer;-><init>(Lcom/b/a/f/RegistryInitializer;Ljava/lang/String;)V

    .line 86
    return-void
.end method

.method public constructor <init>(Lcom/b/a/f/RegistryInitializer;Ljava/lang/String;)V
    .locals 1
    ...
    check-cast v0, Lcom/b/a/f/RegistryInitializer;

    iput-object v0, p0, Lcom/b/a/f/LocalSocketHttpServer;->b:Lcom/b/a/f/RegistryInitializer;

    .line 96
    iput-object p2, p0, Lcom/b/a/f/LocalSocketHttpServer;->c:Ljava/lang/String;
...
.method private a(Lorg/apache/http/params/HttpParams;)Lorg/apache/http/protocol/HttpService;
    ...
    .prologue
    .line 177
    iget-object v0, p0, Lcom/b/a/f/LocalSocketHttpServer;->b:Lcom/b/a/f/RegistryInitializer;

    invoke-interface {v0}, Lcom/b/a/f/RegistryInitializer;->c()Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
...
.method private a(Ljava/lang/String;)V
    ...
    .line 120
    invoke-static {p1}, Lcom/b/a/f/LocalSocketHttpServer;->b(Ljava/lang/String;)Landroid/net/LocalServerSocket;

    move-result-object v1

    iput-object v1, p0, Lcom/b/a/f/LocalSocketHttpServer;->f:Landroid/net/LocalServerSocket;
    ...
    invoke-static {v1}, Lcom/b/a/a/LogUtil;->c(Ljava/lang/String;)V
    ...
    .line 127
    new-instance v2, Lcom/b/a/f/LocalSocketHttpServerConnection;

    invoke-direct {v2}, Lcom/b/a/f/LocalSocketHttpServerConnection;-><init>()V

    .line 131
    :try_start_0
    iget-object v3, p0, Lcom/b/a/f/LocalSocketHttpServer;->f:Landroid/net/LocalServerSocket;
    ...
    .line 134
    invoke-direct {p0}, Lcom/b/a/f/LocalSocketHttpServer;->d()Lorg/apache/http/params/HttpParams;
    ...
    .line 137
    invoke-direct {p0, v1}, Lcom/b/a/f/LocalSocketHttpServer;->a(Lorg/apache/http/params/HttpParams;)Lorg/apache/http/protocol/HttpService;
    ...
    invoke-static {v2, v3}, Lcom/b/a/a/LogUtil;->b(Ljava/lang/Throwable;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1}, Lcom/b/a/a/LogUtil;->b(Ljava/lang/Throwable;Ljava/lang/String;)V
...
.method private static b(Ljava/lang/String;)Landroid/net/LocalServerSocket;
    ...
    :try_start_0
    invoke-static {v0}, Lcom/b/a/a/LogUtil;->a(I)Z
    ...
    invoke-static {v0}, Lcom/b/a/a/LogUtil;->d(Ljava/lang/String;)V
    ...
    invoke-static {v0, v3}, Lcom/b/a/a/LogUtil;->b(Ljava/lang/Throwable;Ljava/lang/String;)V
    ...
    invoke-static {v4, v5}, Lcom/b/a/a/Util;->a(J)V
...
.method static synthetic b()Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .prologue
    .line 59
    sget-object v0, Lcom/b/a/f/LocalSocketHttpServer;->a:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public a()V
    ...
    .line 109
    :try_start_0
    iget-boolean v0, p0, Lcom/b/a/f/LocalSocketHttpServer;->e:Z
    ...
    iput-object v0, p0, Lcom/b/a/f/LocalSocketHttpServer;->d:Ljava/lang/Thread;
    ...
    .line 115
    iget-object v0, p0, Lcom/b/a/f/LocalSocketHttpServer;->c:Ljava/lang/String;
    ...
    .line 116
    :goto_1
    invoke-direct {p0, v0}, Lcom/b/a/f/LocalSocketHttpServer;->a(Ljava/lang/String;)V
    ...
    .line 115
    :cond_1
    invoke-static {}, Lcom/b/a/f/LocalSocketHttpServer;->c()Ljava/lang/String;

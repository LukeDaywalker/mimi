.class public Lcom/b/a/g/i;
.super Lcom/b/a/f/h;
.source "WebSocketHandler.java"


# instance fields
.field private final a:Lcom/b/a/g/g;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/b/a/g/g;)V
    .locals 0
    ...
    .line 79
    iput-object p2, p0, Lcom/b/a/g/i;->a:Lcom/b/a/g/g;
...
.method private static a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 154
    invoke-static {v0}, Lcom/b/a/a/f;->a(Ljava/lang/String;)[B
...
.method private static a(Lorg/apache/http/HttpRequest;)Z
    ...
    invoke-static {p0, v1}, Lcom/b/a/g/i;->a(Lorg/apache/http/HttpMessage;Ljava/lang/String;)Ljava/lang/String;
...
.method private b(Lorg/apache/http/HttpRequest;Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)V
    ...
    .prologue
    .line 128
    invoke-static {p3}, Lcom/b/a/g/j;->a(Lorg/apache/http/protocol/HttpContext;)Lcom/b/a/g/j;
    ...
    invoke-static {p1, v1}, Lcom/b/a/g/i;->a(Lorg/apache/http/HttpMessage;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/b/a/g/i;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 141
    :cond_0
    invoke-virtual {v0}, Lcom/b/a/g/j;->a()Lorg/apache/http/HttpServerConnection;

    move-result-object v1

    invoke-direct {p0, v1, p2}, Lcom/b/a/g/i;->a(Lorg/apache/http/HttpServerConnection;Lorg/apache/http/HttpResponse;)V

    .line 143
    new-instance v1, Lcom/b/a/g/k;

    invoke-virtual {v0}, Lcom/b/a/g/j;->b()Ljava/io/InputStream;

    move-result-object v2

    invoke-virtual {v0}, Lcom/b/a/g/j;->c()Ljava/io/OutputStream;

    move-result-object v0

    iget-object v3, p0, Lcom/b/a/g/i;->a:Lcom/b/a/g/g;

    invoke-direct {v1, v2, v0, v3}, Lcom/b/a/g/k;-><init>(Ljava/io/InputStream;Ljava/io/OutputStream;Lcom/b/a/g/g;)V

    .line 147
    invoke-virtual {v1}, Lcom/b/a/g/k;->a()V
...
.method public a(Lorg/apache/http/HttpRequest;Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)V
    ...
    .prologue
    .line 88
    invoke-static {p1}, Lcom/b/a/g/i;->a(Lorg/apache/http/HttpRequest;)Z
    ...
    .line 99
    :try_start_0
    invoke-direct {p0, p1, p2, p3}, Lcom/b/a/g/i;->b(Lorg/apache/http/HttpRequest;Lorg/apache/http/HttpResponse;Lorg/apache/http/protocol/HttpContext;)V
    :try_end_0

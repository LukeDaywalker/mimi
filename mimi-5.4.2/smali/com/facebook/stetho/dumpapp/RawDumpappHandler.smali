...
.method private static a([B)Lorg/apache/http/HttpEntity;
    ...
    .line 65
    invoke-static {p0}, Lcom/facebook/stetho/dumpapp/RawDumpappHandler;->b([B)Z
...
.method protected a(Lorg/apache/http/HttpRequest;Ljava/io/InputStream;Lorg/apache/http/HttpResponse;)Lorg/apache/http/HttpEntity;
    ...
    .line 45
    :try_start_2
    invoke-virtual {p0}, Lcom/facebook/stetho/dumpapp/RawDumpappHandler;->a()Lcom/facebook/stetho/dumpapp/Dumper;

    move-result-object v4

    invoke-static {p1}, Lcom/facebook/stetho/dumpapp/RawDumpappHandler;->a(Lorg/apache/http/HttpRequest;)[Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v4, p2, v1, v3, v5}, Lcom/facebook/stetho/dumpapp/Dumper;->a(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I

    move-result v4

    .line 46
    const-string/jumbo v5, "X-FAB-ExitCode"
    ...
    invoke-static {v0}, Lcom/facebook/stetho/dumpapp/RawDumpappHandler;->a([B)Lorg/apache/http/HttpEntity;

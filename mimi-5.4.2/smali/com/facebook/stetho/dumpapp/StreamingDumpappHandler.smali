...
.method static synthetic a(Lorg/apache/http/HttpRequest;Lcom/facebook/stetho/dumpapp/Dumper;Ljava/io/InputStream;Ljava/io/OutputStream;)V
    .locals 0

    .prologue
    .line 17
    invoke-static {p0, p1, p2, p3}, Lcom/facebook/stetho/dumpapp/StreamingDumpappHandler;->b(Lorg/apache/http/HttpRequest;Lcom/facebook/stetho/dumpapp/Dumper;Ljava/io/InputStream;Ljava/io/OutputStream;)V

    return-void
.end method

.method private static b(Lorg/apache/http/HttpRequest;Lcom/facebook/stetho/dumpapp/Dumper;Ljava/io/InputStream;Ljava/io/OutputStream;)V
    .locals 4
    ...
    .line 42
    invoke-static {p0}, Lcom/facebook/stetho/dumpapp/StreamingDumpappHandler;->a(Lorg/apache/http/HttpRequest;)[Ljava/lang/String;

    move-result-object v0

    .line 59
    :try_start_0
    invoke-virtual {v1}, Lcom/facebook/stetho/dumpapp/StreamFramer;->a()Ljava/io/PrintStream;

    move-result-object v2

    invoke-virtual {v1}, Lcom/facebook/stetho/dumpapp/StreamFramer;->b()Ljava/io/PrintStream;

    move-result-object v3

    invoke-virtual {p1, p2, v2, v3, v0}, Lcom/facebook/stetho/dumpapp/Dumper;->a(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I

    move-result v0

    .line 60
    invoke-virtual {v1, v0}, Lcom/facebook/stetho/dumpapp/StreamFramer;->a(I)V
    :try_end_0

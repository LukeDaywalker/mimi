.class public Lcom/wumii/android/mimi/models/FeedUtils;
...
.method public static a(Ljava/util/List;Lcom/wumii/android/mimi/models/entities/secret/FeedModule;)Ljava/util/List;
    ...
    .line 27
    :cond_1
    invoke-static {p1}, Lcom/wumii/android/mimi/models/FeedUtils;->a(Lcom/wumii/android/mimi/models/entities/secret/FeedModule;)Landroid/util/SparseArray;

    move-result-object v0

    .line 28
    invoke-static {v1, p1}, Lcom/wumii/android/mimi/models/FeedUtils;->b(Ljava/util/List;Lcom/wumii/android/mimi/models/entities/secret/FeedModule;)Ljava/util/List;

    move-result-object v2

    .line 30
    invoke-static {v1, v0, v2}, Lcom/wumii/android/mimi/models/FeedUtils;->a(Ljava/util/List;Landroid/util/SparseArray;Ljava/util/List;)V

    .line 32
    invoke-static {v1}, Lcom/wumii/android/mimi/models/SecretUtils;->a(Ljava/util/List;)V
...
.method private static a(Ljava/util/List;Landroid/util/SparseArray;Ljava/util/List;)V
    ...
    .line 54
    invoke-static {p0, v4}, Lcom/wumii/android/mimi/models/FeedUtils;->a(Ljava/util/List;I)Z

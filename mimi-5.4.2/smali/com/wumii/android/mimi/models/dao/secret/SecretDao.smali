.class public Lcom/wumii/android/mimi/models/dao/secret/SecretDao;
...
.method public static a(Landroid/database/Cursor;)Lcom/wumii/android/mimi/models/entities/secret/Secret;
    ...
    invoke-static {v0, v4}, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->fromJson(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-static {v0, v1}, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->fromJson(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Lcom/wumii/android/mimi/models/entities/secret/Secret;)V
    ...
    invoke-static {p2}, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->b(Lcom/wumii/android/mimi/models/entities/secret/Secret;)Landroid/content/ContentValues;
...
.method private static b(Lcom/wumii/android/mimi/models/entities/secret/Secret;)Landroid/content/ContentValues;
    ...
    invoke-static {v2}, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->toJson(Ljava/lang/Object;)Ljava/lang/String;
...
.method private b(Landroid/database/sqlite/SQLiteDatabase;Lcom/wumii/android/mimi/models/entities/secret/Secret;)V
    ...
    .line 188
    invoke-direct {p0, p1, p2}, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->a(Landroid/database/sqlite/SQLiteDatabase;Lcom/wumii/android/mimi/models/entities/secret/Secret;)V
...
.method public a(Ljava/lang/String;)Lcom/wumii/android/mimi/models/entities/secret/Secret;
    ...
    .prologue
    .line 130
    iget-object v0, p0, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->mSQLiteDatabasedb:Landroid/database/sqlite/SQLiteDatabase;

    invoke-direct {p0, v0, p1}, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Landroid/database/Cursor;
...
.method public a(Lcom/wumii/android/mimi/models/entities/secret/Secret;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->b(Landroid/database/sqlite/SQLiteDatabase;Lcom/wumii/android/mimi/models/entities/secret/Secret;)V
...
.method public a(Ljava/util/List;)V
    ...
    .line 144
    iget-object v2, p0, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->mSQLiteDatabasedb:Landroid/database/sqlite/SQLiteDatabase;

    invoke-virtual {v0}, Lcom/wumii/android/mimi/models/entities/secret/Secret;->getId()Ljava/lang/String;

    move-result-object v3

    invoke-direct {p0, v2, v3}, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .line 146
    iget-object v3, p0, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->mSQLiteDatabasedb:Landroid/database/sqlite/SQLiteDatabase;

    invoke-direct {p0, v3, v0}, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->a(Landroid/database/sqlite/SQLiteDatabase;Lcom/wumii/android/mimi/models/entities/secret/Secret;)V
    ...
    iget-object v1, p0, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->mSQLiteDatabasedb:Landroid/database/sqlite/SQLiteDatabase;
...
.method public b(Ljava/util/List;)V
    ...
    invoke-direct {p0, v2, v0}, Lcom/wumii/android/mimi/models/dao/secret/SecretDao;->b(Landroid/database/sqlite/SQLiteDatabase;Lcom/wumii/android/mimi/models/entities/secret/Secret;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

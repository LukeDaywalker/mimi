.class public Lcom/wumii/android/mimi/b/cd;
...
.method private a(Landroid/graphics/Bitmap;)Ljava/io/File;
    ...
    .line 49
    iget-object v2, p0, Lcom/wumii/android/mimi/b/cd;->d:Lcom/wumii/android/mimi/models/entities/secret/Secret;
    ...
    .line 56
    iget-object v2, p0, Lcom/wumii/android/mimi/b/cd;->b:Landroid/content/Context;

    invoke-virtual {v0}, Ljava/lang/StringBuffer;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-static {v2, v0}, Lcom/wumii/android/mimi/models/d/j;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    .line 65
    invoke-virtual {p0}, Lcom/wumii/android/mimi/b/cd;->c()Landroid/content/Context;
    ...
    .line 80
    :try_start_0
    invoke-static {v6}, Lorg/a/a/b/c;->b(Ljava/io/File;)Ljava/io/FileOutputStream;
    ...
    .line 83
    :try_start_1
    iget-object v0, p0, Lcom/wumii/android/mimi/b/cd;->c:Lorg/slf4j/Logger;
    ...
    .line 84
    invoke-direct {p0}, Lcom/wumii/android/mimi/b/cd;->k()Ljava/io/File;
    :try_end_1
...
.method private k()Ljava/io/File;
    ...
    .prologue
    .line 95
    iget-object v0, p0, Lcom/wumii/android/mimi/b/cd;->b:Landroid/content/Context;
...
# virtual methods
.method public a(Lcom/wumii/android/mimi/models/entities/secret/Secret;Landroid/graphics/Bitmap;Lcom/wumii/android/mimi/b/l;)V
    .locals 0

    .prologue
    .line 37
    invoke-virtual {p0}, Lcom/wumii/android/mimi/b/cd;->f()Z

    .line 38
    iput-object p2, p0, Lcom/wumii/android/mimi/b/cd;->e:Landroid/graphics/Bitmap;

    .line 39
    iput-object p1, p0, Lcom/wumii/android/mimi/b/cd;->d:Lcom/wumii/android/mimi/models/entities/secret/Secret;

    .line 40
    invoke-virtual {p0, p3}, Lcom/wumii/android/mimi/b/cd;->a(Lcom/wumii/android/mimi/b/l;)V
...
.method public g_()Ljava/io/File;
    ...
    .prologue
    .line 33
    iget-object v0, p0, Lcom/wumii/android/mimi/b/cd;->e:Landroid/graphics/Bitmap;

    invoke-direct {p0, v0}, Lcom/wumii/android/mimi/b/cd;->a(Landroid/graphics/Bitmap;)Ljava/io/File;

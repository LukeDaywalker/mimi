.class Lcom/wumii/android/mimi/manager/SecretManager$MCbd;
...
.method constructor <init>(Lcom/wumii/android/mimi/manager/SecretManager;Ljava/lang/String;Lcom/wumii/android/mimi/models/entities/secret/Comment;Lcom/wumii/android/mimi/models/entities/secret/FeedType;)V
    ...
    .prologue
    .line 93
    iput-object p1, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mSecretManagerd:Lcom/wumii/android/mimi/manager/SecretManager;

    iput-object p2, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mStringa:Ljava/lang/String;

    iput-object p3, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mCommentb:Lcom/wumii/android/mimi/models/entities/secret/Comment;

    iput-object p4, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mFeedTypec:Lcom/wumii/android/mimi/models/entities/secret/FeedType;
...
.method public a(Lcom/wumii/android/mimi/network/HttpRequest;Lcom/wumii/android/mimi/network/HttpJsonResponse;)V
    ...
    .line 97
    iget-object v0, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mStringa:Ljava/lang/String;

    invoke-virtual {v1, v0}, Lcom/wumii/android/mimi/models/event/response/RespEventSendComment;->a(Ljava/lang/String;)V

    .line 98
    iget-object v0, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mCommentb:Lcom/wumii/android/mimi/models/entities/secret/Comment;
    ...
    .line 100
    iget-object v0, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mSecretManagerd:Lcom/wumii/android/mimi/manager/SecretManager;
    ...
    iget-object v2, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mStringa:Ljava/lang/String;

    iget-object v3, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mCommentb:Lcom/wumii/android/mimi/models/entities/secret/Comment;
    ...
    iget-object v3, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mFeedTypec:Lcom/wumii/android/mimi/models/entities/secret/FeedType;
    ...
    iget-object v2, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mSecretManagerd:Lcom/wumii/android/mimi/manager/SecretManager;

    invoke-virtual {v2}, Lcom/wumii/android/mimi/manager/SecretManager;->a()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mStringa:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mSecretManagerd:Lcom/wumii/android/mimi/manager/SecretManager;

    iget-object v3, v3, Lcom/wumii/android/mimi/manager/SecretManager;->mContextf:Landroid/content/Context;

    iget-object v4, p0, Lcom/wumii/android/mimi/manager/SecretManager$MCbd;->mSecretManagerd:Lcom/wumii/android/mimi/manager/SecretManager;

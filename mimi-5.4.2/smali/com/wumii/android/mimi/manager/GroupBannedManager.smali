.class public Lcom/wumii/android/mimi/manager/GroupBannedManager;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 21
    const-class v0, Lcom/wumii/android/mimi/manager/GroupBannedManager;
...
.method public constructor <init>()V
    ...
    .line 33
    iget-object v0, p0, Lcom/wumii/android/mimi/manager/GroupBannedManager;->mHttpProcessora:Lcom/wumii/android/mimi/network/HttpProcessor;
...
.method private b(Lcom/wumii/android/mimi/network/HttpRequest;Lcom/wumii/android/mimi/network/HttpJsonResponse;)V
    ...
    check-cast v0, Lcom/wumii/android/mimi/manager/GroupBannedManager$ICan;
    ...
    .line 89
    iget-object v4, p0, Lcom/wumii/android/mimi/manager/GroupBannedManager;->mAppFacadeg:Lcom/wumii/android/mimi/models/AppFacade;

    invoke-virtual {v4}, Lcom/wumii/android/mimi/models/AppFacade;->s()Lcom/wumii/android/mimi/models/storage/chat/ChatMessageReportStorage;
    ...
    invoke-virtual {v4, v2, v1}, Lcom/wumii/android/mimi/models/storage/chat/ChatMessageReportStorage;->a(Ljava/lang/String;Ljava/util/List;)V
    :try_end_0
    ...
    invoke-virtual {v0, v3, v1, v2}, Lcom/wumii/android/mimi/manager/GroupBannedManager$ICan;->a(ZILjava/lang/String;)V
...
.method private c(Lcom/wumii/android/mimi/network/HttpRequest;Lcom/wumii/android/mimi/network/HttpJsonResponse;)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/wumii/android/mimi/manager/GroupBannedManager$ICan;->b(ZILjava/lang/String;)V
...
.method private d(Lcom/wumii/android/mimi/network/HttpRequest;Lcom/wumii/android/mimi/network/HttpJsonResponse;)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/wumii/android/mimi/manager/GroupBannedManager$ICan;->c(ZILjava/lang/String;)V
...
.method private e(Lcom/wumii/android/mimi/network/HttpRequest;Lcom/wumii/android/mimi/network/HttpJsonResponse;)V
    ...
    invoke-virtual {v2, v5, v6}, Lcom/wumii/jackson/databind/JacksonMapper;->a(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 130
    iget-object v5, p0, Lcom/wumii/android/mimi/manager/GroupBannedManager;->mAppFacadeg:Lcom/wumii/android/mimi/models/AppFacade;

    invoke-virtual {v5}, Lcom/wumii/android/mimi/models/AppFacade;->t()Lcom/wumii/android/mimi/models/storage/chat/ChatBannedMemberStorage;

    move-result-object v5

    invoke-virtual {v5, v1, v2}, Lcom/wumii/android/mimi/models/storage/chat/ChatBannedMemberStorage;->a(Ljava/lang/String;Ljava/util/List;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0, v3, v1, v2}, Lcom/wumii/android/mimi/manager/GroupBannedManager$ICan;->d(ZILjava/lang/String;)V
...
.method public a(Lcom/wumii/android/mimi/network/HttpRequest;Lcom/wumii/android/mimi/network/HttpJsonResponse;)V
    ...
    .line 42
    invoke-direct {p0, p1, p2}, Lcom/wumii/android/mimi/manager/GroupBannedManager;->b(Lcom/wumii/android/mimi/network/HttpRequest;Lcom/wumii/android/mimi/network/HttpJsonResponse;)V
    ...
    .line 44
    invoke-direct {p0, p1, p2}, Lcom/wumii/android/mimi/manager/GroupBannedManager;->c(Lcom/wumii/android/mimi/network/HttpRequest;Lcom/wumii/android/mimi/network/HttpJsonResponse;)V
    ...
    .line 46
    invoke-direct {p0, p1, p2}, Lcom/wumii/android/mimi/manager/GroupBannedManager;->d(Lcom/wumii/android/mimi/network/HttpRequest;Lcom/wumii/android/mimi/network/HttpJsonResponse;)V
    ...
    .line 48
    invoke-direct {p0, p1, p2}, Lcom/wumii/android/mimi/manager/GroupBannedManager;->e(Lcom/wumii/android/mimi/network/HttpRequest;Lcom/wumii/android/mimi/network/HttpJsonResponse;)V

    goto :goto_0
.end method

.method public a(Ljava/lang/String;Lcom/wumii/android/mimi/manager/GroupBannedManager$ICan;)V
    .locals 7
    ...
    .line 56
    iget-object v6, p0, Lcom/wumii/android/mimi/manager/GroupBannedManager;->mHttpProcessora:Lcom/wumii/android/mimi/network/HttpProcessor;
...
.method public b(Ljava/lang/String;Lcom/wumii/android/mimi/manager/GroupBannedManager$ICan;)V
    .locals 7
...
.method public c(Ljava/lang/String;Lcom/wumii/android/mimi/manager/GroupBannedManager$ICan;)V
    .locals 7
...
.method public d(Ljava/lang/String;Lcom/wumii/android/mimi/manager/GroupBannedManager$ICan;)V
    .locals 7

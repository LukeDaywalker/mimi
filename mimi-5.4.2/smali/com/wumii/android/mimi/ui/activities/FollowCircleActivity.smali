...
# interfaces
.implements Lcom/wumii/android/mimi/ui/OnCircleClickListener;


# instance fields
.field private mCircleManagerr:Lcom/wumii/android/mimi/manager/CircleManager;
...
.field private mMCabq:Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity$MCab;

.field private mPinnedHeaderListViewp:Lza/co/immedia/pinnedheaderlistview/PinnedHeaderListView;

.field private mProgressBaro:Landroid/widget/ProgressBar;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mLists:Ljava/util/List;

    .line 260
    return-void
.end method

.method static synthetic a(Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;)Lcom/wumii/android/mimi/manager/CircleManager;
    .locals 1

    .prologue
    .line 47
    iget-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mCircleManagerr:Lcom/wumii/android/mimi/manager/CircleManager;
...
.method static synthetic b(Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;)Landroid/widget/ProgressBar;
    ...
    .prologue
    .line 47
    iget-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mProgressBaro:Landroid/widget/ProgressBar;
...
.method static synthetic c(Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;)Landroid/widget/TextView;
    ...
    .prologue
    .line 47
    iget-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mTextViewn:Landroid/widget/TextView;
...
.method private h()V
    ...
    .prologue
    .line 249
    iget-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mMCabq:Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity$MCab;

    iget-object v1, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mLists:Ljava/util/List;

    invoke-virtual {v0, v1}, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity$MCab;->a(Ljava/util/List;)V

    .line 251
    iget-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mLists:Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mLists:Ljava/util/List;
...
.method public a(Lcom/wumii/android/mimi/models/entities/circle/Circle;)V
    ...
    .line 207
    iget-object v1, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mCircleManagerr:Lcom/wumii/android/mimi/manager/CircleManager;

    invoke-virtual {v1, p0, v0}, Lcom/wumii/android/mimi/manager/CircleManager;->e(Lcom/wumii/android/mimi/ui/activities/BaseMimiActivity;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p0, v0}, Lcom/wumii/android/mimi/manager/CircleManager;->d(Lcom/wumii/android/mimi/ui/activities/BaseMimiActivity;Ljava/lang/String;)V
...
.method public a(Lcom/wumii/android/mimi/ui/widgets/menu/MimiMenuItem;)V
    ...
    .line 151
    sget-object v0, Lcom/wumii/android/mimi/util/EventUtils$MCaf;->mMCafaz:Lcom/wumii/android/mimi/util/EventUtils$MCaf;
    ...
    invoke-virtual {v0, v1}, Lcom/wumii/android/mimi/models/storage/CommonStorage;->f(Z)V

    .line 156
    iget-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mMCabq:Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity$MCab;

    invoke-virtual {v0}, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity$MCab;->a()Ljava/util/List;
    ...
    .line 178
    :cond_3
    invoke-super {p0, p1}, Lcom/wumii/android/mimi/ui/activities/BaseMimiActivity;->a(Lcom/wumii/android/mimi/ui/widgets/menu/MimiMenuItem;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 72
    sget-object v0, Lcom/wumii/android/mimi/util/EventUtils$MCaf;->mMCafay:Lcom/wumii/android/mimi/util/EventUtils$MCaf;
    ...
    invoke-virtual {v0, v1}, Lcom/wumii/android/mimi/models/storage/CommonStorage;->h(Z)V
    ...
    iput-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mPinnedHeaderListViewp:Lza/co/immedia/pinnedheaderlistview/PinnedHeaderListView;

    .line 80
    iget-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mPinnedHeaderListViewp:Lza/co/immedia/pinnedheaderlistview/PinnedHeaderListView;
    ...
    .line 85
    new-instance v0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity$MCab;

    invoke-direct {v0, p0, p0}, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity$MCab;-><init>(Landroid/content/Context;Lcom/wumii/android/mimi/ui/OnCircleClickListener;)V

    iput-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mMCabq:Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity$MCab;

    .line 86
    iget-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mPinnedHeaderListViewp:Lza/co/immedia/pinnedheaderlistview/PinnedHeaderListView;

    iget-object v1, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mMCabq:Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity$MCab;
    ...
    iput-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mProgressBaro:Landroid/widget/ProgressBar;
    ...
    iput-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mTextViewn:Landroid/widget/TextView;

    .line 90
    iget-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mTextViewn:Landroid/widget/TextView;

    new-instance v1, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity$MCaa;

    invoke-direct {v1, p0}, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity$MCaa;-><init>(Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;)V
    ...
    .line 104
    iget-object v2, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mLists:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->mCircleManagerr:Lcom/wumii/android/mimi/manager/CircleManager;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-direct {v0, v2, v1}, Lcom/wumii/android/mimi/ui/widgets/menu/MimiMenuItem;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;)V

    .line 141
    invoke-virtual {p0, v0}, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity;->b(Lcom/wumii/android/mimi/ui/widgets/menu/MimiMenuItem;)V
...
.method protected onDestroy()V
    ...
    invoke-virtual {v0}, Lcom/wumii/android/mimi/manager/CircleManager;->b()V
...
.method public onEvent(Lcom/wumii/android/mimi/models/event/response/RespEventLoadFollowCircles;)V
    .locals 3

    .prologue
    .line 215
    invoke-virtual {p1}, Lcom/wumii/android/mimi/models/event/response/RespEventLoadFollowCircles;->c()Z
    ...
    invoke-virtual {p1}, Lcom/wumii/android/mimi/models/event/response/RespEventLoadFollowCircles;->d()Ljava/util/List;

    move-result-object v1

    invoke-virtual {p1}, Lcom/wumii/android/mimi/models/event/response/RespEventLoadFollowCircles;->e()Ljava/util/List;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lcom/wumii/android/mimi/ui/activities/FollowCircleActivity$MCab;->a(Ljava/util/List;Ljava/util/List;)V
...
.method public onEvent(Lcom/wumii/android/mimi/models/event/response/RespEventSubscribeCircle;)V
    ...
    invoke-virtual {p1}, Lcom/wumii/android/mimi/models/event/response/RespEventSubscribeCircle;->d()Ljava/lang/String;

.class Lcom/baidu/lbsapi/auth/MCf;
...
.field private mMCag:Lcom/baidu/lbsapi/auth/MCf$MCa;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/baidu/lbsapi/auth/MCf;->mStringa:Ljava/lang/String;

    iput-object v1, p0, Lcom/baidu/lbsapi/auth/MCf;->mStringc:Ljava/lang/String;

    iput-object v1, p0, Lcom/baidu/lbsapi/auth/MCf;->mStringd:Ljava/lang/String;

    iput-object v1, p0, Lcom/baidu/lbsapi/auth/MCf;->mListf:Ljava/util/List;

    iput-object v1, p0, Lcom/baidu/lbsapi/auth/MCf;->mMCag:Lcom/baidu/lbsapi/auth/MCf$MCa;

    iput-object p1, p0, Lcom/baidu/lbsapi/auth/MCf;->mContextb:Landroid/content/Context;
...
.method private a(Ljavax/net/ssl/HttpsURLConnection;Ljava/lang/String;Ljava/util/HashMap;)Ljava/lang/String;
    ...
    invoke-static {p3}, Lcom/baidu/lbsapi/auth/MCf;->a(Ljava/util/HashMap;)Ljava/lang/String;
    ...
    iput v0, p0, Lcom/baidu/lbsapi/auth/MCf;->mIe:I
    :try_end_0
    ...
    iput-object v0, p0, Lcom/baidu/lbsapi/auth/MCf;->mStringc:Ljava/lang/String;
    :try_end_6
    ...
    iget-object v1, p0, Lcom/baidu/lbsapi/auth/MCf;->mStringc:Ljava/lang/String;
    ...
    :cond_9
    iget-object v0, p0, Lcom/baidu/lbsapi/auth/MCf;->mStringc:Ljava/lang/String;

    invoke-direct {p0, v0}, Lcom/baidu/lbsapi/auth/MCf;->a(Ljava/lang/String;)V
    ...
    :cond_a
    iget v0, p0, Lcom/baidu/lbsapi/auth/MCf;->mIe:I
    ...
    iget v1, p0, Lcom/baidu/lbsapi/auth/MCf;->mIe:I
...
.method static synthetic a(Lcom/baidu/lbsapi/auth/MCf;)Ljava/util/List;
    .locals 1

    iget-object v0, p0, Lcom/baidu/lbsapi/auth/MCf;->mListf:Ljava/util/List;
...
.method static synthetic a(Lcom/baidu/lbsapi/auth/MCf;Ljava/util/List;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/baidu/lbsapi/auth/MCf;->a(Ljava/util/List;)V
...
.method private a(Ljava/lang/String;)V
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, Lcom/baidu/lbsapi/auth/MCf;->mMCag:Lcom/baidu/lbsapi/auth/MCf$MCa;
    ...
    :goto_1
    invoke-interface {v1, v0}, Lcom/baidu/lbsapi/auth/MCf$MCa;->a(Ljava/lang/Object;)V
...
.method private a(Ljava/util/List;)V
    ...
    iget-object v1, p0, Lcom/baidu/lbsapi/auth/MCf;->mStringd:Ljava/lang/String;

    invoke-direct {p0, v1}, Lcom/baidu/lbsapi/auth/MCf;->b(Ljava/lang/String;)Ljavax/net/ssl/HttpsURLConnection;
    ...
    :cond_3
    invoke-direct {p0, v4}, Lcom/baidu/lbsapi/auth/MCf;->b(Ljavax/net/ssl/HttpsURLConnection;)V
    ...
    invoke-direct {p0, v4}, Lcom/baidu/lbsapi/auth/MCf;->a(Ljavax/net/ssl/HttpsURLConnection;)Z

    move-result v5

    if-eqz v5, :cond_8

    invoke-direct {p0, v4, v1, v0}, Lcom/baidu/lbsapi/auth/MCf;->a(Ljavax/net/ssl/HttpsURLConnection;Ljava/lang/String;Ljava/util/HashMap;)Ljava/lang/String;
...
.method private a(Ljavax/net/ssl/HttpsURLConnection;)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/baidu/lbsapi/auth/MCf;->mContextb:Landroid/content/Context;
...
.method private b(Ljava/lang/String;)Ljavax/net/ssl/HttpsURLConnection;
    ...
    new-instance v6, Lcom/baidu/lbsapi/auth/MCf$MCb;

    invoke-direct {v6, p0}, Lcom/baidu/lbsapi/auth/MCf$MCb;-><init>(Lcom/baidu/lbsapi/auth/MCf;)V
    ...
    new-instance v3, Lcom/baidu/lbsapi/auth/MCh;

    invoke-direct {v3, p0}, Lcom/baidu/lbsapi/auth/MCh;-><init>(Lcom/baidu/lbsapi/auth/MCf;)V

    invoke-static {v3}, Ljavax/net/ssl/HttpsURLConnection;->setDefaultHostnameVerifier(Ljavax/net/ssl/HostnameVerifier;)V

    iget-object v3, p0, Lcom/baidu/lbsapi/auth/MCf;->mContextb:Landroid/content/Context;

    invoke-direct {p0, v3}, Lcom/baidu/lbsapi/auth/MCf;->a(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v3

    sget-boolean v4, Lcom/baidu/lbsapi/auth/MCa;->isZa:Z
    ...
    invoke-static {v4}, Lcom/baidu/lbsapi/auth/MCa;->a(Ljava/lang/String;)V
...
# virtual methods
.method protected a(Ljava/util/HashMap;[Ljava/lang/String;Lcom/baidu/lbsapi/auth/MCf$MCa;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2}, Lcom/baidu/lbsapi/auth/MCf;->a(Ljava/util/HashMap;[Ljava/lang/String;)Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lcom/baidu/lbsapi/auth/MCf;->mListf:Ljava/util/List;

    iput-object p3, p0, Lcom/baidu/lbsapi/auth/MCf;->mMCag:Lcom/baidu/lbsapi/auth/MCf$MCa;
    ...
    iput-object v0, p0, Lcom/baidu/lbsapi/auth/MCf;->mStringd:Ljava/lang/String;

    new-instance v0, Ljava/lang/Thread;

    new-instance v1, Lcom/baidu/lbsapi/auth/MCg;

    invoke-direct {v1, p0}, Lcom/baidu/lbsapi/auth/MCg;-><init>(Lcom/baidu/lbsapi/auth/MCf;)V

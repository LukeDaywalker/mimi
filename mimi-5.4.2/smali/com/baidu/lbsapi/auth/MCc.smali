.class Lcom/baidu/lbsapi/auth/MCc;
...
.field private mMCag:Lcom/baidu/lbsapi/auth/MCc$MCa;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/baidu/lbsapi/auth/MCc;->mStringa:Ljava/lang/String;

    iput-object v1, p0, Lcom/baidu/lbsapi/auth/MCc;->mStringc:Ljava/lang/String;

    iput-object v1, p0, Lcom/baidu/lbsapi/auth/MCc;->mStringd:Ljava/lang/String;

    iput-object v1, p0, Lcom/baidu/lbsapi/auth/MCc;->mHashMapf:Ljava/util/HashMap;

    iput-object v1, p0, Lcom/baidu/lbsapi/auth/MCc;->mMCag:Lcom/baidu/lbsapi/auth/MCc$MCa;

    iput-object p1, p0, Lcom/baidu/lbsapi/auth/MCc;->mContextb:Landroid/content/Context;
...
.method static synthetic a(Lcom/baidu/lbsapi/auth/MCc;)Ljava/lang/String;
    .locals 1

    iget-object v0, p0, Lcom/baidu/lbsapi/auth/MCc;->mStringd:Ljava/lang/String;
...
.method static synthetic a(Lcom/baidu/lbsapi/auth/MCc;Ljava/lang/String;Ljava/util/HashMap;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/baidu/lbsapi/auth/MCc;->a(Ljava/lang/String;Ljava/util/HashMap;)V
...
.method private a(Ljava/lang/String;)V
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, Lcom/baidu/lbsapi/auth/MCc;->mMCag:Lcom/baidu/lbsapi/auth/MCc$MCa;
    ...
    :goto_1
    invoke-interface {v1, v0}, Lcom/baidu/lbsapi/auth/MCc$MCa;->a(Ljava/lang/Object;)V
...
.method private a(Ljava/lang/String;Ljava/util/HashMap;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/baidu/lbsapi/auth/MCc;->b(Ljava/lang/String;)Ljavax/net/ssl/HttpsURLConnection;
    ...
    :cond_2
    invoke-direct {p0, v0}, Lcom/baidu/lbsapi/auth/MCc;->a(Ljavax/net/ssl/HttpsURLConnection;)V

    invoke-direct {p0, v0, p1, p2}, Lcom/baidu/lbsapi/auth/MCc;->a(Ljavax/net/ssl/HttpsURLConnection;Ljava/lang/String;Ljava/util/HashMap;)V
...
.method private a(Ljavax/net/ssl/HttpsURLConnection;Ljava/lang/String;Ljava/util/HashMap;)V
    ...
    invoke-direct {p0, v0}, Lcom/baidu/lbsapi/auth/MCc;->a(Ljava/lang/String;)V
    ...
    invoke-static {p3}, Lcom/baidu/lbsapi/auth/MCc;->a(Ljava/util/HashMap;)Ljava/lang/String;
    ...
    iput v0, p0, Lcom/baidu/lbsapi/auth/MCc;->mIe:I
    :try_end_0
    ...
    iget-object v1, p0, Lcom/baidu/lbsapi/auth/MCc;->mStringc:Ljava/lang/String;
    ...
    :cond_7
    iget v0, p0, Lcom/baidu/lbsapi/auth/MCc;->mIe:I
    ...
    iget v1, p0, Lcom/baidu/lbsapi/auth/MCc;->mIe:I
    ...
    :cond_9
    iget-object v0, p0, Lcom/baidu/lbsapi/auth/MCc;->mStringc:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/baidu/lbsapi/auth/MCc;->mStringc:Ljava/lang/String;
    :try_end_6
...
.method static synthetic b(Lcom/baidu/lbsapi/auth/MCc;)Ljava/util/HashMap;
    .locals 1

    iget-object v0, p0, Lcom/baidu/lbsapi/auth/MCc;->mHashMapf:Ljava/util/HashMap;
...
.method private b(Ljava/lang/String;)Ljavax/net/ssl/HttpsURLConnection;
    ...
    new-instance v6, Lcom/baidu/lbsapi/auth/MCc$MCb;

    invoke-direct {v6, p0}, Lcom/baidu/lbsapi/auth/MCc$MCb;-><init>(Lcom/baidu/lbsapi/auth/MCc;)V
    ...
    new-instance v2, Lcom/baidu/lbsapi/auth/MCe;

    invoke-direct {v2, p0}, Lcom/baidu/lbsapi/auth/MCe;-><init>(Lcom/baidu/lbsapi/auth/MCc;)V

    invoke-static {v2}, Ljavax/net/ssl/HttpsURLConnection;->setDefaultHostnameVerifier(Ljavax/net/ssl/HostnameVerifier;)V

    iget-object v2, p0, Lcom/baidu/lbsapi/auth/MCc;->mContextb:Landroid/content/Context;

    invoke-direct {p0, v2}, Lcom/baidu/lbsapi/auth/MCc;->a(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v2

    sget-boolean v3, Lcom/baidu/lbsapi/auth/MCa;->isZa:Z
    ...
    invoke-static {v3}, Lcom/baidu/lbsapi/auth/MCa;->a(Ljava/lang/String;)V
...
# virtual methods
.method protected a(Ljava/util/HashMap;Lcom/baidu/lbsapi/auth/MCc$MCa;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1}, Lcom/baidu/lbsapi/auth/MCc;->b(Ljava/util/HashMap;)Ljava/util/HashMap;

    move-result-object v0

    iput-object v0, p0, Lcom/baidu/lbsapi/auth/MCc;->mHashMapf:Ljava/util/HashMap;

    iput-object p2, p0, Lcom/baidu/lbsapi/auth/MCc;->mMCag:Lcom/baidu/lbsapi/auth/MCc$MCa;
    ...
    iput-object v0, p0, Lcom/baidu/lbsapi/auth/MCc;->mStringd:Ljava/lang/String;

    new-instance v0, Ljava/lang/Thread;

    new-instance v1, Lcom/baidu/lbsapi/auth/MCd;

    invoke-direct {v1, p0}, Lcom/baidu/lbsapi/auth/MCd;-><init>(Lcom/baidu/lbsapi/auth/MCc;)V

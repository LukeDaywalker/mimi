.class Lcom/baidu/location/ICax;
...
.method private declared-synchronized cp()V
    ...
    invoke-virtual {v0}, Lcom/baidu/location/ICm;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method private cq()V
    ...
    invoke-virtual {v0, v1}, Lcom/baidu/location/ICax$ICa;->sendEmptyMessage(I)Z
...
.method public static for(Landroid/content/Context;)Lcom/baidu/location/ICax;
    ...
    new-instance v0, Lcom/baidu/location/ICax;
...
.method static synthetic for(Lcom/baidu/location/ICax;)V
    .locals 0

    invoke-direct {p0}, Lcom/baidu/location/ICax;->cp()V

    return-void
.end method

.method private declared-synchronized if(Lcom/baidu/location/ICat;Ljava/lang/String;)I
    .locals 11
    ...
    invoke-virtual {v2}, Lcom/baidu/location/ICm;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {p1}, Lcom/baidu/location/ICat;->getGeofenceId()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/baidu/location/ICat;->a()D
    ...
    invoke-virtual {p1}, Lcom/baidu/location/ICat;->case()D
    ...
    invoke-virtual {p1}, Lcom/baidu/location/ICat;->do()F
    ...
    invoke-virtual {p1}, Lcom/baidu/location/ICat;->new()I
    ...
    invoke-virtual {p1}, Lcom/baidu/location/ICat;->goto()J
    ...
    invoke-virtual {p1}, Lcom/baidu/location/ICat;->byte()Z
    ...
    invoke-virtual {p1}, Lcom/baidu/location/ICat;->if()Z
    ...
    invoke-virtual {p1}, Lcom/baidu/location/ICat;->for()Z
...
.method static synthetic if(Lcom/baidu/location/ICax;Lcom/baidu/location/ICat;Ljava/lang/String;)I
    .locals 1

    invoke-direct {p0, p1, p2}, Lcom/baidu/location/ICax;->if(Lcom/baidu/location/ICat;Ljava/lang/String;)I
...
.method static synthetic if(Lcom/baidu/location/ICax;Ljava/util/List;)I
    .locals 1

    invoke-direct {p0, p1}, Lcom/baidu/location/ICax;->do(Ljava/util/List;)I
...
.method static synthetic if(Lcom/baidu/location/ICax;ILjava/lang/String;Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/baidu/location/ICax;->if(ILjava/lang/String;Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;)V

    return-void
.end method

.method static synthetic if(Lcom/baidu/location/ICax;I[Ljava/lang/String;Lcom/baidu/location/GeofenceClient$OnRemoveBDGeofencesResultListener;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/baidu/location/ICax;->if(I[Ljava/lang/String;Lcom/baidu/location/GeofenceClient$OnRemoveBDGeofencesResultListener;)V

    return-void
.end method

.method static synthetic if(Lcom/baidu/location/ICax;Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;ILjava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/baidu/location/ICax;->if(Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;ILjava/lang/String;)V
...
.method public static int(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v1}, Lcom/baidu/location/ICa3;->try(Landroid/content/Context;)V
...
.method public cn()V
    ...
    invoke-direct {v2, p0}, Lcom/baidu/location/ICax$3;-><init>(Lcom/baidu/location/ICax;)V

    invoke-virtual {v0, v2}, Lcom/baidu/location/ICax$ICa;->post(Ljava/lang/Runnable;)Z
...
.method public do(Lcom/baidu/location/ICat;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/baidu/location/ICax$1;-><init>(Lcom/baidu/location/ICax;Lcom/baidu/location/ICat;)V

    invoke-virtual {v0, v1}, Lcom/baidu/location/ICax$ICa;->post(Ljava/lang/Runnable;)Z
...
.method public if(Lcom/baidu/location/ICat;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/baidu/location/ICax$2;-><init>(Lcom/baidu/location/ICax;Lcom/baidu/location/ICat;)V
...
.method public if(Lcom/baidu/location/ICat;Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;)V
    .locals 4

    invoke-direct {p0}, Lcom/baidu/location/ICax;->cr()V
    ...
    invoke-direct {p0}, Lcom/baidu/location/ICax;->cs()J
    ...
    :cond_0
    new-instance v0, Lcom/baidu/location/ICax$ICb;

    invoke-direct {v0, p0, p1, p2}, Lcom/baidu/location/ICax$ICb;-><init>(Lcom/baidu/location/ICax;Lcom/baidu/location/ICat;Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;)V

    invoke-virtual {v0}, Lcom/baidu/location/ICax$ICb;->al()V

    invoke-direct {p0}, Lcom/baidu/location/ICax;->cq()V
...
.method public if(Ljava/util/List;Lcom/baidu/location/GeofenceClient$OnRemoveBDGeofencesResultListener;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/baidu/location/ICax$ICd;-><init>(Lcom/baidu/location/ICax;Ljava/util/List;Lcom/baidu/location/GeofenceClient$OnRemoveBDGeofencesResultListener;)V

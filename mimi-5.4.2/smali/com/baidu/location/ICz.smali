...
.method public static bc()Lcom/baidu/location/ICz;
    ...
    new-instance v0, Lcom/baidu/location/ICz;
...
.method public static byte(Landroid/location/Location;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/baidu/location/ICz;->case(Landroid/location/Location;)Ljava/lang/String;
...
.method static synthetic do(Lcom/baidu/location/ICz;Landroid/location/Location;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/baidu/location/ICz;->for(Landroid/location/Location;)V
...
.method private for(Landroid/location/Location;)V
    ...
    :goto_0
    :try_start_0
    invoke-static {}, Lcom/baidu/location/ICy;->aR()Lcom/baidu/location/ICy;
    ...
    :goto_1
    invoke-virtual {p0}, Lcom/baidu/location/ICz;->aZ()Z
    ...
    invoke-virtual {p0}, Lcom/baidu/location/ICz;->aX()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/baidu/location/ICau;->cj()Z
    ...
    invoke-virtual {v3}, Lcom/baidu/location/ICk;->p()Ljava/lang/String;

    move-result-object v3

    invoke-static {v0, v1, v2, v3}, Lcom/baidu/location/ICq;->do(Lcom/baidu/location/ICu$ICa;Lcom/baidu/location/ICau$ICb;Landroid/location/Location;Ljava/lang/String;)V
    ...
    invoke-direct/range {v1 .. v6}, Lcom/baidu/location/ICz;->if(DDF)V
...
.method private if(Lcom/baidu/location/ICaw;I)I
    .locals 6
    ...
    :cond_2
    invoke-virtual {p1}, Lcom/baidu/location/ICaw;->c7()D
    ...
    :cond_3
    invoke-virtual {p1}, Lcom/baidu/location/ICaw;->da()D
...
.method static synthetic if(Lcom/baidu/location/ICz;Lcom/baidu/location/ICaw;I)I
    .locals 1

    invoke-direct {p0, p1, p2}, Lcom/baidu/location/ICz;->if(Lcom/baidu/location/ICaw;I)I
...
.method static synthetic if(Lcom/baidu/location/ICz;Ljava/util/HashMap;)I
    .locals 1

    invoke-direct {p0, p1}, Lcom/baidu/location/ICz;->if(Ljava/util/HashMap;)I
...
.method private if(Ljava/util/HashMap;)I
    ...
    invoke-direct {p0, v0}, Lcom/baidu/location/ICz;->if(Ljava/util/List;)[D
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Lcom/baidu/location/ICz;->for(DD)[D
...
.method static synthetic if(Lcom/baidu/location/ICz;Landroid/location/GpsSatellite;Ljava/util/HashMap;)Ljava/lang/String;
    .locals 1

    invoke-direct {p0, p1, p2}, Lcom/baidu/location/ICz;->if(Landroid/location/GpsSatellite;Ljava/util/HashMap;)Ljava/lang/String;
...
.method private if(DDF)V
    ...
    invoke-virtual {v2}, Lcom/baidu/location/ICa2;->cA()Ljava/lang/String;
    ...
    invoke-virtual {v2, v1}, Lcom/baidu/location/ICaa;->o(Ljava/lang/String;)V

    goto :goto_1
.end method

.method static synthetic if(Lcom/baidu/location/ICz;Landroid/location/Location;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/baidu/location/ICz;->int(Landroid/location/Location;)V

    return-void
.end method

.method static synthetic if(Lcom/baidu/location/ICz;Ljava/lang/String;Landroid/location/Location;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/baidu/location/ICz;->if(Ljava/lang/String;Landroid/location/Location;)V

    return-void
.end method

.method static synthetic if(Lcom/baidu/location/ICz;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/baidu/location/ICz;->new(Z)V
...
.method private if(Ljava/lang/String;Landroid/location/Location;)V
    ...
    invoke-virtual {v2}, Lcom/baidu/location/ICau;->b7()Lcom/baidu/location/ICau$ICb;

    move-result-object v2

    invoke-static {v1, v2, p2, v0}, Lcom/baidu/location/ICq;->do(Lcom/baidu/location/ICu$ICa;Lcom/baidu/location/ICau$ICb;Landroid/location/Location;Ljava/lang/String;)V
...
.method private if(Ljava/util/List;)[D
    ...
    invoke-direct {p0, v4, v5, v6, v7}, Lcom/baidu/location/ICz;->do(DD)[D
...
.method public static new(Landroid/location/Location;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {}, Lcom/baidu/location/ICz;->a5()Ljava/lang/String;
...
.method private try(Landroid/location/Location;)V
    ...
    invoke-static {v1, v2, p1, v3, v0}, Lcom/baidu/location/ICq;->if(Lcom/baidu/location/ICu$ICa;Lcom/baidu/location/ICau$ICb;Landroid/location/Location;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public declared-synchronized a2()V
    ...
    new-instance v0, Lcom/baidu/location/ICz$ICc;
    ...
    :goto_1
    :try_start_3
    new-instance v0, Lcom/baidu/location/ICz$1;
...
.method public a8()V
    ...
    invoke-virtual {v4}, Lcom/baidu/location/ICk;->p()Ljava/lang/String;

    move-result-object v4

    invoke-static {v1, v2, v3, v4, v0}, Lcom/baidu/location/ICq;->if(Lcom/baidu/location/ICu$ICa;Lcom/baidu/location/ICau$ICb;Landroid/location/Location;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public aX()Ljava/lang/String;
    ...
    invoke-static {}, Lcom/baidu/location/ICc;->try()Ljava/lang/String;
...
.method public aZ()Z
    ...
    invoke-virtual {p0}, Lcom/baidu/location/ICz;->a1()Z
...
.method public ba()V
    ...
    :cond_0
    :try_start_0
    new-instance v0, Lcom/baidu/location/ICz$ICb;
...
.method public int(Z)V
    ...
    invoke-virtual {p0}, Lcom/baidu/location/ICz;->ba()V

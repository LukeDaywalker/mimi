.class Lcom/baidu/location/MCax;
...
.field private static mMCaxiH:Lcom/baidu/location/MCax; = null
...
.field private mMCaiM:Lcom/baidu/location/MCax$MCa;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Lcom/baidu/location/MCax;->mObjectiF:Ljava/lang/Object;
...
.method private co()V
    ...
    iput-object v0, p0, Lcom/baidu/location/MCax;->mHandlerThreadiI:Landroid/os/HandlerThread;

    iget-object v0, p0, Lcom/baidu/location/MCax;->mHandlerThreadiI:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->start()V

    new-instance v0, Lcom/baidu/location/MCax$MCa;

    iget-object v1, p0, Lcom/baidu/location/MCax;->mHandlerThreadiI:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/baidu/location/MCax$MCa;-><init>(Lcom/baidu/location/MCax;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/baidu/location/MCax;->mMCaiM:Lcom/baidu/location/MCax$MCa;
...
.method private declared-synchronized cp()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/baidu/location/MCax;->mContextiy:Landroid/content/Context;

    invoke-static {v0}, Lcom/baidu/location/MCm;->a(Landroid/content/Context;)Lcom/baidu/location/MCm;

    move-result-object v0

    invoke-virtual {v0}, Lcom/baidu/location/MCm;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method private cq()V
    ...
    iget-object v0, p0, Lcom/baidu/location/MCax;->mMCaiM:Lcom/baidu/location/MCax$MCa;

    const/4 v1, 0x3

    invoke-virtual {v0, v1}, Lcom/baidu/location/MCax$MCa;->sendEmptyMessage(I)Z
...
.method private final cr()V
    ...
    invoke-static {v0}, Lcom/baidu/location/MCt;->if(Landroid/content/Context;)Z
...
.method private declared-synchronized cs()J
    ...
    :try_start_0
    iget-object v2, p0, Lcom/baidu/location/MCax;->mContextiy:Landroid/content/Context;
...
.method static synthetic do(Lcom/baidu/location/MCax;)Lcom/baidu/location/MCax$MCa;
    .locals 1
...
.method public static for(Landroid/content/Context;)Lcom/baidu/location/MCax;
    .locals 1

    sget-object v0, Lcom/baidu/location/MCax;->mMCaxiH:Lcom/baidu/location/MCax;

    if-nez v0, :cond_0

    new-instance v0, Lcom/baidu/location/MCax;

    invoke-direct {v0}, Lcom/baidu/location/MCax;-><init>()V

    sput-object v0, Lcom/baidu/location/MCax;->mMCaxiH:Lcom/baidu/location/MCax;

    sget-object v0, Lcom/baidu/location/MCax;->mMCaxiH:Lcom/baidu/location/MCax;

    invoke-direct {v0}, Lcom/baidu/location/MCax;->co()V

    sget-object v0, Lcom/baidu/location/MCax;->mMCaxiH:Lcom/baidu/location/MCax;

    iput-object p0, v0, Lcom/baidu/location/MCax;->mContextiy:Landroid/content/Context;
...
.method static synthetic for(Lcom/baidu/location/MCax;)V
    .locals 0

    invoke-direct {p0}, Lcom/baidu/location/MCax;->cp()V

    return-void
.end method

.method private declared-synchronized if(Lcom/baidu/location/MCat;Ljava/lang/String;)I
    .locals 11
    ...
    invoke-virtual {v2}, Lcom/baidu/location/MCm;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {p1}, Lcom/baidu/location/MCat;->getGeofenceId()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/baidu/location/MCat;->a()D
    ...
    invoke-virtual {p1}, Lcom/baidu/location/MCat;->case()D
    ...
    invoke-virtual {p1}, Lcom/baidu/location/MCat;->do()F
    ...
    invoke-virtual {p1}, Lcom/baidu/location/MCat;->new()I
    ...
    invoke-virtual {p1}, Lcom/baidu/location/MCat;->goto()J
    ...
    invoke-virtual {p1}, Lcom/baidu/location/MCat;->byte()Z
    ...
    invoke-virtual {p1}, Lcom/baidu/location/MCat;->if()Z
    ...
    invoke-virtual {p1}, Lcom/baidu/location/MCat;->for()Z
...
.method static synthetic if(Lcom/baidu/location/MCax;Lcom/baidu/location/MCat;Ljava/lang/String;)I
    .locals 1

    invoke-direct {p0, p1, p2}, Lcom/baidu/location/MCax;->if(Lcom/baidu/location/MCat;Ljava/lang/String;)I
...
.method static synthetic if(Lcom/baidu/location/MCax;Ljava/util/List;)I
    .locals 1

    invoke-direct {p0, p1}, Lcom/baidu/location/MCax;->do(Ljava/util/List;)I
...
.method static synthetic if(Lcom/baidu/location/MCax;)Landroid/content/Context;
    .locals 1
...
.method private if(Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;ILjava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/baidu/location/MCax;->mMCaiM:Lcom/baidu/location/MCax$MCa;

    invoke-virtual {v1, v0}, Lcom/baidu/location/MCax$MCa;->sendMessage(Landroid/os/Message;)Z

    return-void
.end method

.method static synthetic if(Lcom/baidu/location/MCax;ILjava/lang/String;Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/baidu/location/MCax;->if(ILjava/lang/String;Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;)V

    return-void
.end method

.method static synthetic if(Lcom/baidu/location/MCax;I[Ljava/lang/String;Lcom/baidu/location/GeofenceClient$OnRemoveBDGeofencesResultListener;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/baidu/location/MCax;->if(I[Ljava/lang/String;Lcom/baidu/location/GeofenceClient$OnRemoveBDGeofencesResultListener;)V

    return-void
.end method

.method static synthetic if(Lcom/baidu/location/MCax;Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;ILjava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/baidu/location/MCax;->if(Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;ILjava/lang/String;)V
...
.method public static int(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v1}, Lcom/baidu/location/MCa3;->try(Landroid/content/Context;)V
...
.method public cn()V
    ...
    iget-object v1, p0, Lcom/baidu/location/MCax;->mObjectiF:Ljava/lang/Object;
    ...
    new-instance v2, Lcom/baidu/location/MCax$3;

    invoke-direct {v2, p0}, Lcom/baidu/location/MCax$3;-><init>(Lcom/baidu/location/MCax;)V

    invoke-virtual {v0, v2}, Lcom/baidu/location/MCax$MCa;->post(Ljava/lang/Runnable;)Z
...
.method public do(Lcom/baidu/location/MCat;)V
    .locals 2

    iget-object v0, p0, Lcom/baidu/location/MCax;->mMCaiM:Lcom/baidu/location/MCax$MCa;

    new-instance v1, Lcom/baidu/location/MCax$1;

    invoke-direct {v1, p0, p1}, Lcom/baidu/location/MCax$1;-><init>(Lcom/baidu/location/MCax;Lcom/baidu/location/MCat;)V

    invoke-virtual {v0, v1}, Lcom/baidu/location/MCax$MCa;->post(Ljava/lang/Runnable;)Z
...
.method public if(Lcom/baidu/location/MCat;)V
    .locals 2

    iget-object v0, p0, Lcom/baidu/location/MCax;->mMCaiM:Lcom/baidu/location/MCax$MCa;

    new-instance v1, Lcom/baidu/location/MCax$2;

    invoke-direct {v1, p0, p1}, Lcom/baidu/location/MCax$2;-><init>(Lcom/baidu/location/MCax;Lcom/baidu/location/MCat;)V
...
.method public if(Lcom/baidu/location/MCat;Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;)V
    .locals 4

    invoke-direct {p0}, Lcom/baidu/location/MCax;->cr()V

    const-string/jumbo v0, "OnAddBDGeofenceRecesResultListener not provided."

    invoke-static {p2, v0}, Lcom/baidu/location/MCaq;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-direct {p0}, Lcom/baidu/location/MCax;->cs()J
    ...
    :cond_0
    new-instance v0, Lcom/baidu/location/MCax$MCb;

    invoke-direct {v0, p0, p1, p2}, Lcom/baidu/location/MCax$MCb;-><init>(Lcom/baidu/location/MCax;Lcom/baidu/location/MCat;Lcom/baidu/location/GeofenceClient$OnAddBDGeofencesResultListener;)V

    invoke-virtual {v0}, Lcom/baidu/location/MCax$MCb;->al()V

    invoke-direct {p0}, Lcom/baidu/location/MCax;->cq()V
...
.method public if(Ljava/util/List;Lcom/baidu/location/GeofenceClient$OnRemoveBDGeofencesResultListener;)V
    ...
    new-instance v1, Lcom/baidu/location/MCax$MCd;

    invoke-direct {v1, p0, p1, p2}, Lcom/baidu/location/MCax$MCd;-><init>(Lcom/baidu/location/MCax;Ljava/util/List;Lcom/baidu/location/GeofenceClient$OnRemoveBDGeofencesResultListener;)V
